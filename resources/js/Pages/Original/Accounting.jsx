                    ...
                    <div className="bg-white rounded-lg shadow-md p-4 md:p-4 mb-4">
                        ...
                        <div className="flex items-center gap-4">
                            <button
                                type="button"
                                onClick={() =>
                                    setCouponCount(Math.max(0, couponCount - 1))
                                }
                            ...
                            <div className="flex-1 text-center">
                                ...
                                <p className="text-sm text-gray-600 mt-1">枚</p>
                            </div>
                            <button
                                type="button"
                                onClick={() => setCouponCount(couponCount + 1)}
                    ...
                    >
                        ...
                        <div className="grid grid-cols-3 gap-2 mb-6">
                            ...
                            <button
                                type="button"
                                onClick={() =>
                                    setReceivedAmount(finalAmount.toString())
                                }
